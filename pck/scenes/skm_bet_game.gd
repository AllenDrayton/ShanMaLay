...
const historyTextures = [
	preload("res://pck/assets/skm_bet/win.png"),
	preload("res://pck/assets/skm_bet/lose.png")
]
...
func _start(body):
	...
	for h in body.history:
		...
		for i in range(4):
			...
			row.get_node(str(i)).rect_min_size = Vector2(35,35)
