...
var bet_arr = [100,500,1000,2000,5000,10000]
var bet_index = 0
var bet_amount = 100
...
func firstcoinselect():
	var sel = $BetPanel/BetSelect.get_node("0")
	sel.texture_normal=sel.texture_pressed
	sel.rect_position.y -= 30
...
func _on_bet_select(index):
	...
	if index!=bet_index:
		prev_selected=bet_index
		var prev_sel = $BetPanel/BetSelect.get_node(str(prev_selected))
