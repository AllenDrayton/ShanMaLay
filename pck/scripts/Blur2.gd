...
var polygonPoints = [Vector2(0, 896), Vector2(2000, 904), Vector2(1992, 0), Vector2(1520, 0),
	Vector2(1544, 208), Vector2(1528, 328), Vector2(1528, 752), Vector2(504, 768),
	Vector2(496, 168), Vector2(1424, 160), Vector2(1504, 120), Vector2(1528, 128),
	Vector2(1512, 0), Vector2(0, 0)] # Replace this with your actual points
